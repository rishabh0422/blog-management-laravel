...
Route::middleware(['auth','user'])->prefix('user')->name('user.')->group(function () {
    ...
    Route::get('/posts',[UserPostsController::class,'index'])->name('posts');
    Route::resource('dashboard',UserDashController::class)->except('index');
    Route::resource('posts',UserPostsController::class)->except('index'); 
});
